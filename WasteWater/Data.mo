...
package Data
  ...
  package ASM1
    ...
    record vars "Variables as used in the ASM1 models"
    ...
    record SmallPlantIni "Initialisation record for ASM1 SmallPlant model"
      ...
      parameter Types.VolumeFlowRate Q=21477 "Inflow";
      parameter Types.VolumeFlowRate Q_2=Q/2 "Half of inflow" annotation (Dialog(enable=false));
      parameter Types.MassConcentration Si=3 "Soluble inert organic matter";
      parameter Types.MassConcentration Ss=64 "Readily biodegradable substrate";
      parameter Types.MassConcentration Xi=59 "Particulate inert organic matter";
      parameter Types.MassConcentration Xs=224 "Slowly biodegradable substrate";
      parameter Types.MassConcentration Xbh=32 "Active heterotrophic biomass";
      parameter Types.MassConcentration Xba=0 "Active autotrophic biomass";
      parameter Types.MassConcentration Xp=0 "Particulate products from biomass decay";
      parameter Types.MassConcentration So=0 "Dissolved oxygen";
      parameter Types.MassConcentration Sno=0 "Nitrate and nitrite nitrogen";
      parameter Types.MassConcentration Snh=30 "Ammonium nitrogen";
      parameter Types.MassConcentration Snd=6.4 "Soluble biodegradable organic nitrogen";
      parameter Types.MassConcentration Xnd=12 "Particulate biodegradable organic nitrogen";
      parameter Types.Alkalinity Salk=7 "Alkalinity";
