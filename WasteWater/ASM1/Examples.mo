...
package Examples "Demonstration examples of the components of the ASM1 library"
  ...
  equation
    ...
    connect(PI1.y, blower2.u) annotation (Line(points={{109,50},{114,
            50},{114,-84},{18,-84},{18,-55},{13.8,-55},{13.8,-55}}));
    connect(divider.Out2, RecyclePump.In) annotation (Line(points={{40,2.5},
            {44,2.5},{44,-8.7},{-74,-8.7}}));
    connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-94,
            -14.8},{-104,-14.8},{-104,27.5}}));
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{16,
            -28.8},{15.5,-28.8},{15.5,-30},{-112,-30},{-112,31.5},{
            -104,31.5}}));
    ...
    connect(Constant1.y, blower1.u) annotation (Line(points={{-46,-77},
            {-7.2,-77},{-7.2,-55},{-13.2,-55}},
                                          color={0,0,255}));
    connect(WastePump.Out, WasteSludge.In) annotation (Line(points={{79,
            -42.2},{81,-42.2},{81,-42},{83,-42},{83,-42.2},{87,-42.2}}));
...
"),   experiment(StopTime=14, Tolerance=1e-07));
  ...
  record SmallPlantIni
    ...
    parameter Real PI1_x=-3.511076570565e-004 "Start output of controller"
      ...
      /* Inflow [15]*/
      parameter Boolean useCI=true "Use constant inflow?";
      parameter WWU.VolumeFlowRate Q=21477 "Inflow";
      parameter WWU.VolumeFlowRate Q_2=Q/2 "Half of inflow";
